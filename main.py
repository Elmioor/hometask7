...
class Matrix:
    ...
    def __add__(self, other):
        return Matrix(self.list_list[0]+other.list_list[0], self.list_list[0]+other.list_list[1],self.list_list[2]+other.list_list[2])


    def __str__(self):
        return f"матрица выглядит так: \n {self.list_list[0]} \n {self.list_list[1]}"




zzz = Matrix([[1,2,3],[4,5,6]])
zzz2= Matrix([[1,1,1],[1,1,1]])
